...
\begin{exercise}[Optional 3]**
	...
	Using a similar method\todo{How does one do this problem?} to that of \autoref{exercise:repeated-roots},
...
\end{remark}
\begin{exercise}\todo{make this problem optional because it is not required for any other exercise.}
	\label{exercise:r-s}
...
\begin{definition}
	\label{definition:}
	Let $G$ be a group. The {\bf commutator subgroup} of $G$, denoted $\left[ G,G \right]$ is the subgroup of $G$ generated \todo{expand this remark, we haven't defined what ``generated by'' means.}
