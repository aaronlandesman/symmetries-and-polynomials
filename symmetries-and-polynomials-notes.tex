...
\begin{exercise}[Challenge 1] An amazing fact about the discriminant is that it can always be written as a polynomial in terms of the coefficients, for the quadratic this was \autoref{definition:quadratic-discriminant} and \autoref{exercise:quadratic-discriminant-in-roots}. Now let's see this for a \textbf{depressed cubic} (i.e. coefficient of $ x^2$ is 0). Consider the cubic
	\begin{align*}
		P(x) &= x^3 + px + q
	\end{align*}
