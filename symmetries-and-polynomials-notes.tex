...
\section{Solving the Cubic}
	...
	One of the most amazing facts about the discriminant is that it can always be written as a polynomial in terms of the coefficients. We'll see this later in details, for now let's see an example.
	
	We'll start with a \textbf{depressed cubic} (i.e. coefficient of $ x^2$ is 0) and come back to the more general cubic later. Consider
		\begin{align*}
			P(x) &= x^3 + px + q
		\end{align*}
	...
	\begin{exercise}
		...
		\begin{enumerate}
			...
			\item Convince yourself that if $ P(x)$ has repeated roots if and only if all 3 roots and $ x_1 $ and $ x_2$ are real and $ P(x_1).P(x_2) = 0$.
	...
	\end{theorem}
	The proof of this is too cumbersome and is just some large algebraic manipulations.
	...
	\label{exercise:coefficients_depressed_cubic}
		Express the coefficients of $ P(x)$ in terms of $ \beta_1$, $ \beta_3$, and $ \beta_3$.
	\end{exercise}
...
\end{exercise}
  ...
  \end{align} 
	...
	\begin{exercise}
		...
		Find $ \beta_1, \beta_2, \beta_3$ in terms of $ \mu_1, \mu_2$. \hint{Find $ \beta_1 + \beta_2$, $ \omega \beta_1 + \omega^2 \beta_2$, $ \omega^2 \beta_1 + \omega \beta_2$. }
	\end{exercise}
	...
	\begin{exercise}
		...
		$ $ 
		\begin{enumerate}
			\item Use the previous exercise to find $ \beta_1. \beta_2.\beta_3$ in terms of $ \mu_1, \mu_2$. Use this to find $ \mu_1^3 + \mu_2^3$ in terms of $ p, q$.\hint{First expand $ \beta_2. \beta_3$.}
			\item Find $ \mu_1 .\mu_2$ in terms of $ p,q$.
			\item Find the coefficients of the quadratic whose roots are $ \mu_1^3$ and $ \mu_2^3$ and solve it. (Do you recognize anyone?)
		\end{enumerate}
	\end{exercise}
	...
	\begin{exercise} 	What if your cubic is happy and not depressed? Suppose the polynomial $ P(x) = x^3 + ax^2 + bx + c$ has roots $ \beta_1, \beta_2, \beta_3$. 
		\begin{enumerate}
...
\section{The Galois Correspondence}
	...
	The symmetric group $ S_n$ naturally \textbf{acts} on the set of polynomials in $ n$ variables by permuting the variables. A polynomial $Q(\zeta_1, \zeta_2, \dots, \zeta_n)$ is said to be symmetric if for all $\sigma \in S_n $, 
		\begin{align*}
	...
	\begin{exercise}
		This exercise justifies why the intermediate variables for a quartic satisfy a cubic polynomial, whose coefficients are polynomials in the original polynomial.		\begin{enumerate}
			\item Verify that if $ P(x)$ is a quartic then $ \lambda_1 + \lambda_2 + \lambda_3$, $ \lambda_1 \lambda_2 + \lambda_1 \lambda_3 + \lambda_2 \lambda_3$, and $ \lambda_1 \lambda_2 \lambda_3$ as defined in \autoref{equation:intermediate_variables_quartic} are symmetric in $ \gamma_i$. 
	...
	\subsection{Fixed points}
		A set of polynomials $ V = \{ Q_i(\zeta_1, \zeta_2, \dots, \zeta_n) \}_i$ is said to be \textbf{fixed point-wise} by an element $ \sigma \in S_n$ if 
			...
			\end{align*}
		for every $ Q_i \in V$. By this definition, the set of symmetric polynomials is fixed point-wise by the every element of $ S_n$. 
