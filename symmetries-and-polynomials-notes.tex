...
=======
			...
			\item Convince yourself that if $ P(x)$ has repeated roots then $ P(x_1) \cdot P(x_2) = 0$. \todo{aaron: what does $P(x_1).P(x_2)$ mean? does it mean multiply the values? why not say $P(x_1) = 0$ or $P(x_2) = 0$, or $P(x_1) \cdot P(x_2)$?}
				\todo{aaron: i feel this part of the exercise might be tricky if they haven't seen calculus, i'd be in favor of removing it since it doesnt seem so enlightening}
