  ...
  \end{align} 
	...
	\begin{exercise}
		...
		\begin{enumerate}
			...
			\item Show that $ \mu_1 \mu_2 = -3p$. \todo{Aaron: I think you get $-2p$ instead of $-3p$}
...
\subsection{Further optional questions on the quartic and roots of unity}			
	...
	\begin{exercise}[Optional 2] $ $
		...
		\end{align*}
		is called the $ n^{th}$ \textbf{cyclotomic polynomial}. Miraculously, all the coefficients of $ \Phi_n(x)$ are integers!
		\begin{enumerate}[resume]
			...
			\item ** Show that $ \Phi_n(x)$ have integer coefficients and are irreducible over the integers.
				\todo{aaron: I would do this last part by showing the coefficients live in both the ring of integers and $\bq$ (the latter using galois invariance)
				and then conclude they live in $\mathscr O_K \cap \bq = \bz$. But this is surely not the way you intended. Can you give a hint outlining your intended proof?}
		\end{enumerate}
	\end{exercise}
