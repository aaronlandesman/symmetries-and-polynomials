...
maybe we can get them there quicker by moving 5.2 to an appendix or something}
	...
	\begin{exercise}
		\todo{I think we should be very precise by what variables they are symmetric in}
  ...
  \end{align*}
		\begin{enumerate}
			\item Show that $ \mu_1^3 + \mu_2^3 $ and $ \mu_1^3  \mu_2^3$ are symmetric. 
				\todo{symmetric in which variables?}
			\item Also show that $ \mu_1 + \mu_2$ is \emph{not} symmetric. \todo{in which variables?} This was the reason we could not use $ \mu_1, \mu_2$ as our intermediate variables.
		\end{enumerate}
	\end{exercise}
	...
	\todo{i think it might be a bit much to include this since people probably then wont get to the galois correpsondence. maybe we can include it after the galois correspondence, or else as an appendix, or as challenge questions?}
